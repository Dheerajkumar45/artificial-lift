...
const componentData = {
  "motor": {
    icon: "⚙️", title: "Prime Mover & Gearbox",
    text: "Provides the raw rotational power (electric motor or gas engine). The gear reducer scales the high-speed motor rotation into the high-torque, low-speed rotation required to lift heavy fluid columns."
  },
  "beam": {
    icon: "⚖️", title: "Walking Beam & Horsehead",
    text: "Pivoting on the Samson post, it converts rotational power from the pitman arms into vertical reciprocating motion. The horsehead ensures the polished rod remains perfectly aligned with the wellbore."
  },
  "wellhead": {
    icon: "🛢️", title: "Wellhead & Stuffing Box",
    text: "The structural foundation at the surface. The stuffing box contains packing glands that seal around the moving polished rod, preventing high-pressure fluid leaks while allowing the rod to stroke."
  },
  "rods": {
    icon: "⛓️", title: "Sucker Rod String",
    text: "A highly-engineered steel tether that transmits the lifting motion from the surface down to the pump. Tapered designs (using multiple diameters) are used in deep wells to balance tensile stress."
  },
  "tubing": {
    icon: "🕳️", title: "Tubing & Casing",
    text: "Casing lines the drilled hole to prevent collapse. Tubing is the inner conduit through which the produced oil and water are lifted to the surface by the pump's displacement."
  },
  "pump": {
    icon: "⬇️", title: "Downhole Pump Assembly",
    text: "The heart of the artificial lift system. Contains a moving plunger with a traveling valve, and a stationary barrel with a standing valve. It traps and displaces fluid upward on every stroke cycle."
  }
};
